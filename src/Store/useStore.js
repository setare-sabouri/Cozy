  ...
  fetchWeather: async (City) => {
    ...
    try {
      ...
      if (mainCondition.includes("thunder") || mainCondition.includes("storm")) {
        ...
        weatherMode = "Rainy";
      } else if (mainCondition.includes("snow") || mainCondition.includes("blizzard")) {
        weatherMode = "Snowy";
      } else if (["mist", "smoke", "haze", "dust", "fog", "sand", "ash", "squall", "tornado"].some((term) => mainCondition.includes(term))
      ) {
        weatherMode = "Snowy"; // fallback for other 
      }
